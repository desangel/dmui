...
module.exports = function( Release ) {
	...
	var
		files = [
			"dist/js/dmui.js",
			"dist/js/dmui.min.js",
			"dist/js/dmui.min.map",
			"dist/js/dmui.slim.js",
			"dist/js/dmui.slim.min.js",
			"dist/js/dmui.slim.min.map",
			"js/core.js"
		],
	...
	Release.define( {
		...
		generateArtifacts: function( callback ) {
			...
			Release.exec(
				"grunt custom:-ajax,-effects,-deprecated --filename=dmui.slim.js && " +
					"grunt remove_map_comment --filename=dmui.slim.js",
				"Grunt custom failed"
			);
		 ...
		 * It was changed to reuse npm publish code in dmui-release
